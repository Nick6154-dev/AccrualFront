...
var MobileStepper = React61.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime70.jsxs)(MobileStepperRoot, _extends({
    ...
    children: [backButton, variant === "text" && (0, import_jsx_runtime70.jsxs)(React61.Fragment, {
...
var NativeSelect = React62.forwardRef(function NativeSelect2(inProps, ref) {
  ...
  return (0, import_jsx_runtime72.jsx)(React62.Fragment, {
...
var Snackbar = React82.forwardRef(function Snackbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime96.jsx)(ClickAwayListener_default, _extends({
    onClickAway
  }, ClickAwayListenerProps, {
...
var Tabs = React106.forwardRef(function Tabs2(inProps, ref) {
  ...
  const [displayScroll, setDisplayScroll] = React106.useState({
    start: false,
    end: false
  });
  ...
  const handleTabsScroll = React106.useMemo(() => debounce_default(() => {
    updateScrollButtonState();
  }), [updateScrollButtonState]);
  React106.useEffect(() => {
    return () => {
...
var _excluded81 = ["children", "className", "color", "disabled", "disableFocusRipple", "fullWidth", "onChange", "onClick", "selected", "size", "value"];
